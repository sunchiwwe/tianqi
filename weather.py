...
def main():    #定义函数main()
    ...
    def show_data(weather_dict,city_name):#显示数据
        ...
        Label(root1,text = "开发者：孙驰",fg = "green",bg = "yellow").place(x=10,y=255,width=125,height=20)#作者网站
        Button(root1,text = '确认并退出',width=10,command = root1.quit).place(x=500,y=235,width = 80,height=40)#退出按钮
        root1.mainloop()
    ...
    Button(root, text = '退出',width=10,command = root.quit)\
            .grid(row = 3, column = 1, sticky = E, padx = 10, pady = 15)
    if running==1:
